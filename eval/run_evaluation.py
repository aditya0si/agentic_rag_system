...
def compute_simplified_metrics(
    ...
    for q, ans, ctxs, gt in zip(questions, answers, contexts, ground_truths, strict=True):
...
def generate_comparison_table(
    naive_metrics: dict[str, float], agentic_metrics: dict[str, float]
) -> str:
...
def main():
    ...
    try:
        ...
        output = {
            "naive_rag": {"metrics": naive_metrics, "results": naive_results},
            "agentic_rag": {"metrics": agentic_metrics, "results": agentic_results},
            "test_set": test_set,
        }
