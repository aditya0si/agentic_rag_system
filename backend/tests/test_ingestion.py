...
from core.ingestion import extract_text, chunk_document, extract_text_from_pdf, extract_text_from_docx, extract_text_from_txt
...
class TestDocumentIngestion:
    ...
    def test_chunk_document(self):
        ...
        chunks = chunk_document(pages, doc_id="doc_test", doc_name="test.txt", chunk_size=100, chunk_overlap=20)
